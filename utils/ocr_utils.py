...
def alpr_single_image(image, file_name, alpr=None):
...
def review_image(
    image_path, yolo_box, text_label, output_csv, output_dir="reviewed_images"
):
        ...
        for idx, line in enumerate(lines):
            if idx > 0:
                ...
                review_image(
                    ...
                    line,
                    row["text"],
                    output_csv=output_csv_fp,
                    output_dir=review_img_folder,
                )
